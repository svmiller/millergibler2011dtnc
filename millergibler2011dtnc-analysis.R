getwd()
setwd("/Users/stevenmiller/Dropbox/teaching/posc3410/millergibler2011dtnc")
library(car)
library(lattice) #for histogram(). I like histogram() better than hist().

Data <- read.csv("http://dl.dropbox.com/s/zdltd0o4znzsn01/millergibler2011dtnc-data.csv")
summary(Data)
